...
set for [i=1:20] paxis i tics 0,1,5
set for [i=1:20] paxis i range [0:5]
set for [i=1:20] paxis i label font "default, 16" offset 0.5,-0.5
set lmargin  15
set bmargin  15
set rmargin  15
set tmargin  15
...
p \
keyentry with spiderplot ls 1 lw 3 title "Enroot", \
for [i=2:14] "features_spider_data.dat" index 0 u i ls 1 lw 2 pt 6 ps 2 ti columnhead, \
newspiderplot, \
keyentry with spiderplot ls 3 lw 3 title "Charliecloud", \
for [i=2:14] "features_spider_data.dat" index 1 u i ls 3 lw 2 pt 6 ps 2 ti columnhead, \
newspiderplot, \
keyentry with spiderplot ls 6 lw 3 title "Singularity", \
for [i=2:14] "features_spider_data.dat" index 2 u i ls 6 lw 2 pt 6 ps 2 ti columnhead
